var/obj/list/shuttles = list(("escape" = new /datum/shuttle_manager(/area/shuttle/escape/centcom, 0)),
...
("mining" = new /datum/shuttle_manager(/area/shuttle/mining/station, 10, 1)),
("laborcamp" = new /datum/shuttle_manager(/area/shuttle/laborcamp/station, 10, 1)),
("ferry" = new /datum/shuttle_manager(/area/shuttle/transport1/centcom, 0)),
("xenoarch" = new /datum/shuttle_manager(/area/shuttle/xenoarch/station, 10, 1)))
